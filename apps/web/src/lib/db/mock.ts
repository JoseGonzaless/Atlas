...
let expenses: Expense[] = [
  ...
  { id: 'e-22', partnershipId: 'p-1', scope: 'personal', amount: 14.99,  description: 'Duolingo Super',          category: 'subscriptions', paidBy: 'user-1', source: 'manual', date: subDays(NOW, 2),  createdAt: subDays(NOW, 2),  settlementPeriodId: null, settledAt: null },
  { id: 'e-23', partnershipId: 'p-1', scope: 'personal', amount: 32.50,  description: 'Haircut',                 category: 'other',         paidBy: 'user-1', source: 'manual', date: subDays(NOW, 4),  createdAt: subDays(NOW, 4),  settlementPeriodId: null, settledAt: null },
  { id: 'e-24', partnershipId: 'p-1', scope: 'personal', amount: 120.00, description: 'Gym membership',          category: 'other',         paidBy: 'user-1', source: 'manual', date: subDays(NOW, 7),  createdAt: subDays(NOW, 7),  settlementPeriodId: null, settledAt: null },
  { id: 'e-25', partnershipId: 'p-1', scope: 'personal', amount: 8.49,   description: 'Kindle book',             category: 'subscriptions', paidBy: 'user-1', source: 'manual', date: subDays(NOW, 9),  createdAt: subDays(NOW, 9),  settlementPeriodId: null, settledAt: null },
  { id: 'e-26', partnershipId: 'p-1', scope: 'personal', amount: 55.00,  description: 'Parking downtown',        category: 'other',         paidBy: 'user-1', source: 'manual', date: subDays(NOW, 12), createdAt: subDays(NOW, 12), settlementPeriodId: null, settledAt: null },
  { id: 'e-27', partnershipId: 'p-1', scope: 'personal', amount: 210.00, description: 'Dental cleaning',         category: 'other',         paidBy: 'user-1', source: 'manual', date: subDays(NOW, 15), createdAt: subDays(NOW, 15), settlementPeriodId: null, settledAt: null },
  { id: 'e-28', partnershipId: 'p-1', scope: 'personal', amount: 67.30,  description: 'Amazon order — gadgets',  category: 'shopping',      paidBy: 'user-1', source: 'manual', date: subDays(NOW, 18), createdAt: subDays(NOW, 18), settlementPeriodId: null, settledAt: null },
  { id: 'e-29', partnershipId: 'p-1', scope: 'personal', amount: 11.99,  description: 'YouTube Premium',         category: 'subscriptions', paidBy: 'user-1', source: 'manual', date: subDays(NOW, 20), createdAt: subDays(NOW, 20), settlementPeriodId: null, settledAt: null },
  { id: 'e-30', partnershipId: 'p-1', scope: 'personal', amount: 38.00,  description: 'Coffee + pastries',       category: 'food',          paidBy: 'user-1', source: 'bot',    date: subDays(NOW, 22), createdAt: subDays(NOW, 22), settlementPeriodId: null, settledAt: null },
  { id: 'e-31', partnershipId: 'p-1', scope: 'personal', amount: 149.00, description: 'Annual cloud storage',    category: 'subscriptions', paidBy: 'user-1', source: 'manual', date: subDays(NOW, 25), createdAt: subDays(NOW, 25), settlementPeriodId: null, settledAt: null },
  { id: 'e-32', partnershipId: 'p-1', scope: 'personal', amount: 29.00,  description: 'Lunch solo — ramen',      category: 'food',          paidBy: 'user-1', source: 'bot',    date: subDays(NOW, 27), createdAt: subDays(NOW, 27), settlementPeriodId: null, settledAt: null },
  { id: 'e-33', partnershipId: 'p-1', scope: 'personal', amount: 500.00, description: 'Roth IRA contribution',   category: 'investments',   paidBy: 'user-1', source: 'manual', date: subDays(NOW, 30), createdAt: subDays(NOW, 30), settlementPeriodId: null, settledAt: null },
  { id: 'e-34', partnershipId: 'p-1', scope: 'personal', amount: 24.50,  description: 'Uber rides',              category: 'other',         paidBy: 'user-1', source: 'bot',    date: subDays(NOW, 33), createdAt: subDays(NOW, 33), settlementPeriodId: null, settledAt: null },
  { id: 'e-35', partnershipId: 'p-1', scope: 'personal', amount: 75.00,  description: 'New jeans',               category: 'shopping',      paidBy: 'user-1', source: 'manual', date: subDays(NOW, 35), createdAt: subDays(NOW, 35), settlementPeriodId: null, settledAt: null },
  { id: 'e-36', partnershipId: 'p-1', scope: 'personal', amount: 18.00,  description: 'Audiobook — biography',   category: 'entertainment', paidBy: 'user-1', source: 'manual', date: subDays(NOW, 38), createdAt: subDays(NOW, 38), settlementPeriodId: null, settledAt: null },
  { id: 'e-37', partnershipId: 'p-1', scope: 'personal', amount: 92.40,  description: 'Pharmacy — vitamins',     category: 'other',         paidBy: 'user-1', source: 'manual', date: subDays(NOW, 40), createdAt: subDays(NOW, 40), settlementPeriodId: null, settledAt: null },
  { id: 'e-38', partnershipId: 'p-1', scope: 'personal', amount: 15.00,  description: 'Solo movie ticket',       category: 'entertainment', paidBy: 'user-1', source: 'manual', date: subDays(NOW, 42), createdAt: subDays(NOW, 42), settlementPeriodId: null, settledAt: null },
  { id: 'e-39', partnershipId: 'p-1', scope: 'personal', amount: 200.00, description: 'Side project domain + hosting', category: 'other',  paidBy: 'user-1', source: 'manual', date: subDays(NOW, 45), createdAt: subDays(NOW, 45), settlementPeriodId: null, settledAt: null },
]
